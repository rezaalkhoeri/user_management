...
<head>
  ...
  <title>Users Management | Input Data Users</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Data Users</li>
      </ol>
    </section>
        ...
        <form role="form" method="post" action="{{ route('home.update-user', [$xusers->PERNR, $xusers->ASSIGNMENT_NUMBER]) }}">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="number" style="" class="form-control" value="{{ $xusers->PERNR }}" name="personal_number" id="personal_number" disabled>
            </div>
            <div class="form-group">
              <label>Name</label>
